...
# --- Media Processing Endpoints & Background Tasks (ALL MOVED to routes/processing_routes.py) ---
...
# --- Delete Asset Endpoints (ALL MOVED to routes/processing_routes.py) ---
...
# --- Settings Endpoints (ALL MOVED to routes/settings_routes.py) ---
...
if __name__ == "__main__":
    ...
    # Ensure MEDIA_DIR is correctly loaded and exists or is creatable by user actions
    # Example: Check if MEDIA_DIR exists and log warning if not, guiding user to settings.
    # media_dir_path = BASE_DIR / (get_setting("media_directory_name") or "media")
    # if not media_dir_path.exists():
    #     logger.warning(f"Media directory '{media_dir_path}' does not exist. Please configure it in Settings.")
